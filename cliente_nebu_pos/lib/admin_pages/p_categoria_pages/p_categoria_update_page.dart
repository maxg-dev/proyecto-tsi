...
class PCategoriaUpdatePage extends StatefulWidget {
  final int id;
  const PCategoriaUpdatePage(this.id, {super.key});
  @override
  State<PCategoriaUpdatePage> createState() => _PCategoriaUpdatePageState();
}

class _PCategoriaUpdatePageState extends State<PCategoriaUpdatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
          future: PCategoriasProvider().get(widget.id),
  ...
  void update() async {
    ...
    await PCategoriasProvider().update(widget.id, nombre);
